...
import { GitHubRepo, GitHubCommit, GitHubUser } from "@/types/github-api";
...
export default function GitHubWatcher() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      localStorage.setItem("lastSearched", username);
    } catch {
  ...
  return (
    <Card className="mx-2 relative overflow-hidden border-0 shadow-2xl bg-gradient-to-br from-card via-card to-card/95 backdrop-blur-sm">
      {/* Decorative background elements */}
      <div className="absolute inset-0 bg-grid-pattern opacity-[0.02]" />
      <div className="absolute top-0 right-0 w-32 h-32 dark:bg-gradient-to-bl dark:from-primary/40 dark:to-transparent rounded-full -translate-y-16 translate-x-16 bg-gradient-to-bl from-primary/60 to-transparent border border-primary/50" />
      <div className="absolute bottom-0 left-0 w-24 h-24 dark:bg-gradient-to-tr dark:from-accent/40 dark:to-transparent rounded-full translate-y-12 -translate-x-12 bg-gradient-to-tr from-accent/60 to-transparent border border-accent/50" />
      ...
      <CardContent className="relative space-y-6">
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <Button
              ...
              className="cursor-pointer h-11 px-6 bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg hover:shadow-xl transition-all duration-200"
            >
              {loading ? (
                <>
        ...
        {/* User Info Section */}
        {hasSearched && user && (
          <div className="flex items-center gap-8 p-4 rounded-lg bg-muted/30 border border-border/50">
            <div className="flex items-center justify-center gap-2">
              <Image
                ...
                onError={(e) => {
                  ...
                  target.src = `https://github.com/identicons/github.com/${user.login}.png`;
                }}
                width={64}
                height={64}
              />
